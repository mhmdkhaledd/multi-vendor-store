...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => $__env->getContainer()->make(Illuminate\View\Factory::class)->make('mail::header'),'data' => ['url' => config('app.php.url')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(config('app.php.url'))]); ?>
<?php echo e(config('app.php.name')); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
© <?php echo e(date('Y')); ?> <?php echo e(config('app.php.name')); ?>. <?php echo app('translator')->get('All rights reserved.'); ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Mohamed Khaled\store\vendor\laravel\framework\src\Illuminate\Mail/resources/views/html/message.blade.php ENDPATH**/ ?>
