...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.label','data' => ['required' => $required]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['required' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($required)]); ?>
        <?php echo e($label); ?>
...
<input type="<?php echo e($type); ?>" id="<?php echo e($id); ?>" name="<?php echo e($name); ?>" value="<?php echo e(old($name, $value)); ?>" <?php echo e($attributes->class(['form-control', 'is-invalid' => $errors->has($name)])); ?>>
...
<?php /**PATH C:\Users\Mohamed Khaled\store\resources\views/components/form/input.blade.php ENDPATH**/ ?>