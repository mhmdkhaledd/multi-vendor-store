                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            ...
                                            <div class="form-input form">
                                                <input name="addr[billing][post_code]" placeholder="Post Code" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            <label>Country</label>
                                            <div class="form-input form">
                                                <input name="addr[billing][country]" placeholder="countries" >
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            <label>Post Code</label>
                                            <div class="form-input form">
                                                <input name="addr[shipping][post_code]" placeholder="Post Code" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="single-form form-default">
                                            <label>Country</label>
                                            <div class="form-input form">
                                                <input name="addr[shipping][country]" placeholder="countries" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
...
<?php endif; ?>
<?php /**PATH C:\Users\Mohamed Khaled\store\resources\views/front/checkout.blade.php ENDPATH**/ ?>